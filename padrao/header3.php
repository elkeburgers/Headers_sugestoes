...
<div class="container mt-n4 col-lg-6">
            <nav class="nav-bar d-flex justify-content-center">
                <ul class="nav" id="headerNavbar">
                    <li class="nav-item">
                        <a class="nav-link header3texto" href="previsao.php">Previsão</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link header3texto" href="caronas.php">Carona</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link header3texto" href="desapego.php">Desapego</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link header3texto" href="encontre.php">Encontre</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link header3texto" href="blog.php">Blog</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link header3texto" href="noticias.php">Notícias</a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle header3texto" href="#" id="navbarDropdown" role="button"
        ...
        <nav>
            <ul class="nav font-weight-bold">
                ...
                <li class="nav-item">
                    <a class="nav-link header3texto" href="#">Olá <?php echo $usuario["nome"]; ?></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link header3texto" href="#">Sair</a>
                </li>
                <?php } else { ?>
                <li class="nav-item">
                    <a class="nav-link header3texto" href="paginaLogin.php">Login</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link header3texto" href="cadastroUsuario.php">Cadastro</a>
                </li>
                <?php } ?>
            </ul>
        </nav>
